...
namespace init_args
{
	...
	static const b::arg_name<b::string, sp_tag> sp;
	static const b::arg_name<int, ip_tag> ip;
	static const b::arg_name<bool, bp_tag> bp;
}
...
static const b::arg_name<unsigned, 0> addend;
static const b::arg_name<unsigned*, 1> partial_sum;
...
static const b::arg_name<int, 0> int_arg;
